...
- **Command**: Which command to use (prefer: /colorize, /extract, /quieter, /onboard, /distill, /harden, /animate, /adapt, /critique, /typeset, /delight, /bolder, /overdrive, /optimize, /arrange, /clarify, /polish, /audit, /normalize — or other installed skills you're sure exist)
