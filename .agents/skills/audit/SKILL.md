...
- **Suggested command**: Which command to use (prefer: /colorize, /extract, /quieter, /onboard, /distill, /harden, /animate, /adapt, /critique, /typeset, /delight, /bolder, /overdrive, /optimize, /arrange, /clarify, /polish, /audit, /normalize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /colorize, /extract, /quieter, /onboard, /distill, /harden, /animate, /adapt, /critique, /typeset, /delight, /bolder, /overdrive, /optimize, /arrange, /clarify, /polish, /audit, /normalize. You may also suggest other installed skills you're sure exist, but never invent commands.
